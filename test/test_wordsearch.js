...
describe("#wordSearch()", function() {
  ...
  it("should return undefined if the array is empty", function() {
    const result = wordSearch([[]], 'ASYNC')

    assert.isUndefined(result);
  });

  it("should return true if the word is present and reversed vertically", function() {
    const result = wordSearch([
      ['C', 'W', 'C', 'F', 'Q', 'U', 'A', 'L'],
      ['N', 'E', 'I', 'N', 'F', 'E', 'L', 'D'],
      ['Y', 'F', 'C', 'F', 'Q', 'U', 'A', 'L'],
  ...
  it("should return true if the word is present and reversed horizontally", function() {
    const result = wordSearch([
      ['A', 'W', 'C', 'F', 'Q', 'U', 'A', 'L'],
      ['D', 'L', 'E', 'F', 'N', 'I', 'E', 'S'],
      ['Y', 'F', 'C', 'F', 'Q', 'U', 'A', 'L'],
